...
import { Logo } from './NavbarLogo'; // Adjust the import path as necessary
                  ...
                  <div className="space-y-2 py-6">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={`#${item.href.substring(1)}`}
                        className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium tracking-wider leading-7 text-gray-100 hover:bg-gray-200"
                        onClick={() => handleClick(item.href)}
                      >
                        {item.name}
                      </a>
...
//                     priority={true}
//                   />
//                   <span className="text-white tracking-wider font-medium text-sm">Sixtusdev</span>
//                 </a>
