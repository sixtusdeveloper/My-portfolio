    ...
    <div className="pb-2 pt-36" id="Hero">
      ...
      <ReadMoreModal isOpen={isReadMoreModalOpen} onClose={handleReadMoreModalToggle}>
        <div className="px-8 max-h-[80vh] overflow-auto no-scrollbar">
          ...
          style={{ width: 'auto', height: 'auto' }}
          />
          <h2 className="text-xl my-2 font-bold text-purple tracking-wide text-center">
            About Me
          </h2>
          <p className="text-center text-sm px-8 py-2 tracking-wide text-gray-200 leading-6">
            I am Sixtus Aondoakaa, a Software Engineer passionate about developing innovative and scalable solutions. My portfolio showcases a wide range of projects from front-end designs to back-end architectures.
          </p>
        </div>
      </ReadMoreModal>
    </div>
